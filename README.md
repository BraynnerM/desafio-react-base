...
Esta é uma solução para Quest de React Base.
...
- Converter o texto para cor vermelha e deixar tudo maiúsculo.
- Ao clicar no botão será emitido um alerta com a label do botão.
...
- URL da solução: [Github](https://github.com/BraynnerM/desafio-react-base)
-  URL do site no Github Pages: [Desafio React Base](https://braynnerm.github.io/desafio-react-base/)
...
- Propriedades personalizadas do CSS (style in-line)
- Javascript
- React
- JSX
- Github
